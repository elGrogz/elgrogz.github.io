...
description: "Some Thoughts on 'Agile Testing Condensed'"
...
According to _Agile Testing Condensed_ this is one of the key activities that a team can do to level up its planning, development and testing. Often teams make unseen assumptions about how a system should behave, and this lack of communication can result in missed requirements and issues further down the line.
...
## _Agile testers play numerous roles_
...
## _The customer ultimately judges quality_
